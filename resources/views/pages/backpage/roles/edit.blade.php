    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        {!! Form::model($role, ['method' => 'PATCH','route' => ['roles.update', $role->id], 'class' => 'theme-form']) !!}
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group m-checkbox-inline mb-0">
                                        ...
                                        @foreach($permission as $value)
                                            <label>{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => 'checkbox_animated')) }}
                                            {{ $value->name }}</label>
                                            <br/>
                                        @endforeach
                                    </div>
