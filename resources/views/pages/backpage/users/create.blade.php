		    ...
		    <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url ('/dashboard/users')}}"><i data-feather="users"></i></a></li>
                        ...
                        {!! Form::open(array('route' => 'users.store','method'=>'POST', 'files'=> true)) !!}
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="row mb-2">
                                        <div class="col-auto">
                                            <img class="img-90 rounded-circle" id="modal-preview" src="https://via.placeholder.com/150"><br><br>
