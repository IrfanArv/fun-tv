...
(function(jQuery) {
    ...
    var registerDependencies = function() {
            var PluginJsConfig = {
                "js_dependencies": {
                    "asyncloader.js": "main/js/vendor/asyncloader.js",
                    "asyncloader": "main/js/asyncloader.min.js?ver=1.0",
                    "circle-progress": "main/js/circle-progress.min.js?ver=1.0",
                    "isotope.pkgd": "main/js/isotope.pkgd.min.js?ver=1.0",
                    "jquery.countTo": "main/js/jquery.countTo.min.js?ver=1.0",
                    "jquery.magnific-popup": "main/js/jquery.magnific-popup.min.js?ver=1.0",
                    "owl.carousel": "main/js/owl.carousel.min.js?ver=1.0",
                    "slick": "main/js/slick.min.js?ver=1.0"
                }
            };
