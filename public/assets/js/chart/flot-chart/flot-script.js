        ...
        function plotAccordingToChoices() {
            ...
            if (data.length > 0) {
                $.plot("#toggling-series-flot", data, {
                    ...
                    colors: [CubaAdminConfig.primary, "#f8d62b" ,"#3498db" ,"#51bb25" , CubaAdminConfig.secondary , "#dc3545" ,"#f8d62b"]
...
$(function() {
    ...
    var data4_errors = [0.1, 0.4, 0.2];
        ...
        var data = [
            ...
            {color: "#3498db",  points: data2_points, data: data2, label: "data2"},
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: [ CubaAdminConfig.primary , "#51bb25" ,"#f8d62b" ,"#3498db" ,"#dc3545", "#6c757d" , CubaAdminConfig.secondary ]
    });
