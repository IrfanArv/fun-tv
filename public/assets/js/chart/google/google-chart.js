...
function drawBasic() {
  ...
  if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
       colors: ["#f8d62b", "#51bb25" , "#3498db"  , CubaAdminConfig.secondary , CubaAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
        colors: ["#f8d62b", "#3498db" , "#51bb25", CubaAdminConfig.secondary , CubaAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        slices: {  4: {offset: 0.2},
          ...
          colors: ["#dc3545", CubaAdminConfig.primary , CubaAdminConfig.secondary , "#51bb25", "#3498db", "#f8d62b","#dc3545", CubaAdminConfig.primary , "#f8d62b", "#51bb25", CubaAdminConfig.primary , CubaAdminConfig.secondary ,"#51bb25", CubaAdminConfig.primary , "#3498db", "#f8d62b", CubaAdminConfig.primary , CubaAdminConfig.primary, "#3498db", CubaAdminConfig.secondary , CubaAdminConfig.primary , "#51bb25"]
        };
  ...
  if ($("#combo-chart").length > 0) {
      ...
      var options = {
        ...
        height: 500,
        width:'100%',
        colors: [CubaAdminConfig.primary, CubaAdminConfig.secondary , "#51bb25", "#3498db", "#f8d62b"]
    };
